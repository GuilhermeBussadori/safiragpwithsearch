...
def main():
    ...
    agent = initialize_agent(tools, llm, agent=AgentType.SELF_ASK_WITH_SEARCH, system_message=system_message, agent_kwargs={"system_message": system_message}, verbose=True)
